            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($name == "" || $body == "") {
                    ...
                    if ($inserted_rows) {
                        ...
                        echo "<span class='error'>Something is worng! Page doesn't inserted.</span>";
                    }
                }
            }
        ?>
                 ...
                 <form action="addpage.php" method="post">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" autocomplete="off" placeholder="Enter Post Title..." class="medium" />
                            </td>
                        </tr>
